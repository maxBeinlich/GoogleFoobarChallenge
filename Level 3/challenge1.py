"""
========================================================
Google Foobar challenge - Level 3, Challenge 1
========================================================
...
by the brightest scientists on Bunny Planet. There are two types: Mach bombs (M) and 
...
3 Mach bombs and 5 Facula bombs, or 5 Mach bombs and 2 Facula bombs. The replication
...
and you might overload the mass capacitors and create a singularity at the heart of 
...
(Thus it may be impossible to deploy the bombs to destroy the LAMBCHOP, but that's not 
going to stop you from trying!) 
...
bombs necessary to destroy the LAMBCHOP, or the string "impossible" if this can't be 
done! M and F will be string representations of positive integers no larger than 10^50. 
For example, if M = "2" and F = "1", one generation would need to pass, so the solution 
